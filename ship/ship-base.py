...
blacklisted_files = [
    ...
    'global_packs/required_resources/Saffron Create Addon',
    'scripts/create_addon.zs',
    'scripts/content_tweaker_create_addon.zs',
    'patchouli_books/saffron_guide_book/en_us/entries/intro/create.json'
]
